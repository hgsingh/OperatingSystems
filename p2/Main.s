...
! Make sure _P_Thread_ has hash value 0xd98e6cc5 (decimal -644977467)
	...
	cmp	r1,0
	bne	_Label_59
! Make sure _P_Synch_ has hash value 0x283eadc6 (decimal 675196358)
	set	_packageName,r2
	set	0x283eadc6,r3
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_314 = &_Global_pcLock
	set	_Global_pcLock,r1
	store	r1,[r14+-212]
!   Prepare Argument: offset=12  value=0  sizeInBytes=1
	mov	0,r1
	storeb	r1,[r15+4]
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_315 = &_Global_fullSem
	set	_Global_fullSem,r1
	store	r1,[r14+-208]
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_316 = &_Global_emptySem
	set	_Global_emptySem,r1
	store	r1,[r14+-204]
...
! ASSIGNMENT STATEMENT...
	...
	mov	"\0\0AS",r10
!   NEW CLASS Constructor...
!   ZeroMemory: monitorLock = zeros  (sizeInBytes=24)
	load	[r14+8],r4
	add	r4,28,r4
	store	r0,[r4]
	store	r0,[r4+4]
...
! ASSIGNMENT STATEMENT...
	...
	mov	"\0\0AS",r10
!   NEW CLASS Constructor...
!   ZeroMemory: testCond = zeros  (sizeInBytes=16)
	load	[r14+8],r4
	add	r4,52,r4
	store	r0,[r4]
	store	r0,[r4+4]
...
!   _temp_602 = _temp_602 + 4
	...
	store	r1,[r14+-20]
!   Next value...
!   Data Move: *_temp_602 = 1  (sizeInBytes=4)
	mov	1,r1
	load	[r14+-20],r2
	store	r1,[r2]
!   _temp_602 = _temp_602 + 4
...
!   make sure array has size 5
	...
	bvs	_runtimeErrorOverflow
	bne	_runtimeErrorWrongArraySize
!   Data Move: *_temp_600 = *_temp_604  (sizeInBytes=24)
	load	[r14+-12],r5
	load	[r14+-48],r4
	load	[r5],r1
	store	r1,[r4]
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-84]
!   Data Move: *_temp_618 = 1  (sizeInBytes=4)
	mov	1,r1
	load	[r14+-84],r2
	store	r1,[r2]
! IF STATEMENT...
...
!   _temp_624 = &status
	...
	add	r1,4,r1
	store	r1,[r14+-76]
!   Move address of _temp_624 [p ] into _temp_625
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   Data Move: _temp_623 = *_temp_625  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-80]
!   if _temp_623 != 1 then goto _Label_620		(int)
	load	[r14+-80],r1
	mov	1,r2
	cmp	r1,r2
	bne	_Label_620
...
!   _temp_628 = _temp_629 rem 5		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-60]
!   Move address of _temp_627 [_temp_628 ] into _temp_630
!     make sure index expr is >= 0
	load	[r14+-60],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   Data Move: _temp_626 = *_temp_630  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-68]
!   if _temp_626 == 2 then goto _Label_620		(int)
	load	[r14+-68],r1
	mov	2,r2
	cmp	r1,r2
	be	_Label_620
...
!   _temp_633 = _temp_634 rem 5		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-40]
!   Move address of _temp_632 [_temp_633 ] into _temp_635
!     make sure index expr is >= 0
	load	[r14+-40],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-32]
!   Data Move: _temp_631 = *_temp_635  (sizeInBytes=4)
	load	[r14+-32],r1
	load	[r1],r1
	store	r1,[r14+-48]
!   if _temp_631 == 2 then goto _Label_620		(int)
	load	[r14+-48],r1
	mov	2,r2
	cmp	r1,r2
	be	_Label_620
...
!   _temp_636 = &status
	...
	add	r1,4,r1
	store	r1,[r14+-28]
!   Move address of _temp_636 [p ] into _temp_637
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-24]
!   Data Move: *_temp_637 = 2  (sizeInBytes=4)
	mov	2,r1
	load	[r14+-24],r2
	store	r1,[r2]
! SEND STATEMENT...
...
!   _temp_672 = _temp_673 rem 5		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-156]
!   Move address of _temp_671 [_temp_672 ] into _temp_674
!     make sure index expr is >= 0
	load	[r14+-156],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   Data Move: _temp_670 = *_temp_674  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-164]
!   if _temp_670 != 1 then goto _Label_667		(int)
	load	[r14+-164],r1
	mov	1,r2
	cmp	r1,r2
	bne	_Label_667
...
!   Data Move: _temp_675 = *_temp_677  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-144]
!   if _temp_675 == 2 then goto _Label_667		(int)
	load	[r14+-144],r1
	mov	2,r2
	cmp	r1,r2
	be	_Label_667
...
!   _temp_680 = _temp_681 rem 5		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-124]
!   Move address of _temp_679 [_temp_680 ] into _temp_682
!     make sure index expr is >= 0
	load	[r14+-124],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   Data Move: _temp_678 = *_temp_682  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-132]
!   if _temp_678 == 2 then goto _Label_667		(int)
	load	[r14+-132],r1
	mov	2,r2
	cmp	r1,r2
	be	_Label_667
...
!   _temp_684 = _temp_685 rem 5		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-108]
!   Move address of _temp_683 [_temp_684 ] into _temp_686
!     make sure index expr is >= 0
	load	[r14+-108],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   _temp_695 = _temp_696 rem 5		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-80]
!   Move address of _temp_694 [_temp_695 ] into _temp_697
!     make sure index expr is >= 0
	load	[r14+-80],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-72]
!   Data Move: _temp_693 = *_temp_697  (sizeInBytes=4)
	load	[r14+-72],r1
	load	[r1],r1
	store	r1,[r14+-88]
!   if _temp_693 != 1 then goto _Label_690		(int)
	load	[r14+-88],r1
	mov	1,r2
	cmp	r1,r2
	bne	_Label_690
...
!   _temp_700 = _temp_701 rem 5		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-60]
!   Move address of _temp_699 [_temp_700 ] into _temp_702
!     make sure index expr is >= 0
	load	[r14+-60],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-52]
!   Data Move: _temp_698 = *_temp_702  (sizeInBytes=4)
	load	[r14+-52],r1
	load	[r1],r1
	store	r1,[r14+-68]
!   if _temp_698 == 2 then goto _Label_690		(int)
	load	[r14+-68],r1
	mov	2,r2
	cmp	r1,r2
	be	_Label_690
...
!   Data Move: _temp_703 = *_temp_705  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-48]
!   if _temp_703 == 2 then goto _Label_690		(int)
	load	[r14+-48],r1
	mov	2,r2
	cmp	r1,r2
	be	_Label_690
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-24]
!   Data Move: *_temp_709 = 2  (sizeInBytes=4)
	mov	2,r1
	load	[r14+-24],r2
	store	r1,[r2]
! SEND STATEMENT...
...
!   _temp_761 = 4		(4 bytes)
	...
	store	r1,[r14+-36]
!   Initialize FOR-LOOP index variable
!   Data Move: p = _temp_760  (sizeInBytes=4)
	load	[r14+-40],r1
	store	r1,[r14+-44]
_Label_756:
!   Perform the FOR-LOOP termination test
!   if p > _temp_761 then goto _Label_759		
	load	[r14+-44],r1
	load	[r14+-36],r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-24]
!   Data Move: _temp_767 = *_temp_769  (sizeInBytes=4)
	load	[r14+-24],r1
	load	[r1],r1
	store	r1,[r14+-32]
